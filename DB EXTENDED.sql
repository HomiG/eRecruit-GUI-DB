...
('123432211', 'A Grevenon', 'SoftSol A.E.', 2103452133, 'Ahepa', 44, 'Athina', 'Greece'), 
...
/* add ADMIN */
insert into `user` (username, `password`, `name`, surname, reg_date, email) values 
('admin', 'admin', 'admin', 'admin', '2017-06-23 13:12:34', 'admin@unigram.com');
...
username VARCHAR(12),
PRIMARY KEY (username),
CONSTRAINT ADMN FOREIGN KEY (username) REFERENCES `user`(username) ON DELETE CASCADE ON UPDATE CASCADE
);
...
('2019-08-08', 1800, 'data analyst', 'Patra, Greece', 'n_tri', '2018-07-13', '2018-12-20'),
('2025-02-01', 1450, 'web programmer', 'Patra, Greece', 'n_tri', '2018-07-13', '2025-02-01'),
('2045-02-01', 2100, 'mobile app developer', 'Patra, Greece', 'n_tri', '2018-10-24', '2028-01-12'),
...
CREATE TABLE tomeas (
tomeas_title VARCHAR(36) NOT NULL,
description TEXT,
etaireia_id char(9) NOT NULL,
belongs_to_sub VARCHAR(36),
PRIMARY KEY (tomeas_title),
CONSTRAINT TOMEAS_ETAIREIA FOREIGN KEY (etaireia_id) REFERENCES etaireia(AFM) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT TOMEAS_TITTLE FOREIGN KEY (belongs_to_sub) REFERENCES tomeas(tomeas_title) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;

INSERT INTO tomeas(tomeas_title, description, etaireia_id, belongs_to_sub) VALUES
('Artificial Intelligence', 'In computer science, artificial intelligence (AI), sometimes called machine intelligence, is intelligence demonstrated by machines, in contrast to the natural intelligence displayed by humans. Colloquially, the term "artificial intelligence" is often used to describe machines (or computers) that mimic "cognitive" functions that humans associate with the human mind, such as "learning" and "problem solving"',  '023451232', NULL),
('Speech', 'Speech recognition is a interdisciplinary subfield of computational linguistics that develops ...... AI effect', '023451232', 'Artificial Intelligence'),
('Speech To Text', 'Speech to text transcription of speech into text, real time video captioning, Court reporting', '023451232', 'Speech'),

('Operation Systems', 'An operating system (OS) is system software that manages computer hardware and software resources and provides common services for computer programs. Time-sharing operating systems schedule tasks for efficient use of the system and may also include accounting software for cost allocation of processor time, mass storage, printing, and other resources. ', '023451232', NULL),
('Linux', 'Linux is a family of open source Unix-like operating systems based on the Linux kernel, an operating system kernel first released on September 17, 1991 by Linus Torvalds.Linux is typically packaged in a Linux distribution.', '023451232', 'Operation Systems'),
('Bash', 'Bash is a Unix shell and command language written by Brian Fox for the GNU Project as a free software replacement for the Bourne shell. First released in 1989, it has been used widely as the default login shell for most Linux distributions and Apples macOS Mojave and earlier versions. A version is also available for Windows 10. It is also the default user shell in Solaris 11', '023451232', 'Linux');
...
table_nam varchar(36) NOT NULL ,
success ENUM('Yes','No'),
PRIMARY KEY (AA)
)engine=InnoDB;

CREATE TABLE interview(
A_A int(10) NOT NULL AUTO_INCREMENT,
...
education TINYINT,
experience TINYINT,
PRIMARY KEY(A_A,candidate_username),
CONSTRAINT INTER_RECR FOREIGN KEY (recruiter_username) REFERENCES recruiter(username) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT INTER_CAND FOREIGN KEY (candidate_username) REFERENCES candidate(username) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT INTER_JOB FOREIGN KEY (job_id) REFERENCES job(id) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;

insert into interview (recruiter_username, candidate_username, job_id, int_date, start_time, duration, comments, personality, education, experience) values
('n_tri', 'zazahir23', 2, '2019-01-01', '12:23:34', 1, 'love', 1, 3, 1),
('n_tri', 'lionarF', 2, '2012-02-01', '12:03:00', 2, 'that', 6, 4, 2),
('msmith', 'lionarF',5, '2006-08-10', '02:20:20', 5, 'for', 0, 0, 0),
('pavkie', 'mnikol' ,11, '2011-11-11', '20:03:30', 4, 'me', 2, 5, 3),
('pavkie', 'mnikol' ,11, '2011-11-11', '20:03:30', 4, 'me', 2, 5, 3),
('n_tri', 'abrown', 1, '2016-01-05', '12:23:34', 7, 'oops', 5, 0, 3),
('n_tri', 'abrown', 1, '2016-11-12', '02:20:34', 4, 'lps', 3, 6, 2),
('n_tri', 'abrown', 1, '2016-11-12', '02:20:34', 4, 'lps', 7, 4, 5);
